        ...
        <div className="flex flex-wrap items-center gap-4 px-4 py-2 bg-slate-900/30 backdrop-blur-md border border-white/5 rounded-2xl shadow-inner">
            ...
            <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] text-slate-400 font-bold uppercase tracking-tight">
                    Last Scan: {isLoading ? '...' : (lastUpdate ? formatDistanceToNow(lastUpdate, { addSuffix: true, locale: ko }) : 'N/A')}
                </span>
            </div>
            ...
            <div className="hidden md:flex items-center gap-2">
                ...
                <span className="text-[10px] text-slate-400 font-bold uppercase tracking-tight">AI-Engine v2.1 (Production)</span>
            </div>
            ...
            <div className="hidden lg:flex items-center gap-2">
                ...
                <span className="text-[10px] text-slate-400 font-bold uppercase tracking-tight">Auto-Verification: Active</span>
            </div>
        </div>
    );
};
