            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-10">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-6xl max-h-[90vh] bg-[#020617]/80 backdrop-blur-3xl border border-white/10 rounded-[2.5rem] overflow-hidden shadow-[0_0_80px_rgba(99,102,241,0.3)] flex flex-col md:flex-row min-w-[320px]"
                    >
                        ...
                        <div className="w-full md:w-[45%] p-8 border-b md:border-b-0 md:border-r border-white/5 flex flex-col relative z-10">
                            ...
                            <div className="flex-1 flex flex-col justify-center min-h-[300px]">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-white/5 p-4 rounded-3xl border border-white/5 hover:bg-white/10 transition-colors">
                                        <p className="text-[10px] text-slate-500 uppercase font-black tracking-widest mb-1">급등 발생 확률</p>
                                    ...
                                    <div className="bg-white/5 p-4 rounded-3xl border border-white/5 hover:bg-white/10 transition-colors">
                                        <p className="text-[10px] text-slate-500 uppercase font-black tracking-widest mb-1">위험 등급</p>
                                        <div className={clsx(
                        ...
                        <div className="flex-1 p-8 bg-black/20 flex flex-col overflow-y-auto no-scrollbar min-w-0">
                            <div className="space-y-10">
                                ...
                                <div className="pt-6 flex flex-col sm:flex-row gap-4">
                                    <button className="flex-1 bg-white text-black font-black py-4 rounded-2xl hover:bg-indigo-50 transition-colors uppercase tracking-widest text-xs shadow-lg shadow-white/5">
                                        시뮬레이션 투자하기
                                    </button>
