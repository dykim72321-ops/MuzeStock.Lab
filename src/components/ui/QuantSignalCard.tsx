...
export const QuantSignalCard: React.FC<QuantSignalCardProps> = ({ data }) => {
    ...
    return (
        <div className="w-full max-w-2xl p-6 bg-slate-900 border border-slate-800 hover:border-indigo-500/30 transition-colors duration-500 rounded-2xl shadow-xl text-slate-100 font-sans relative overflow-hidden group">
            ...
            <div className="p-4 bg-indigo-500/5 rounded-xl border border-indigo-500/10 relative z-10 hover:border-indigo-500/30 transition-colors">
                ...
                <p className="text-sm text-slate-300 leading-relaxed font-medium break-keep">{reasoning_ko}</p>
            </div>
